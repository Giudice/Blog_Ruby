...
class CommentairesControllerTest < ActionController::TestCase
  ...
  test "should create commentaire" do
    assert_difference('Commentaire.count') do
      post :create, commentaire: { auteur: @commentaire.auteur, contenu: @commentaire.contenu, date: @commentaire.date, post_id: @commentaire.post_id }
    end
  ...
  test "should update commentaire" do
    patch :update, id: @commentaire, commentaire: { auteur: @commentaire.auteur, contenu: @commentaire.contenu, date: @commentaire.date, post_id: @commentaire.post_id }
    assert_redirected_to commentaire_path(assigns(:commentaire))
  end
